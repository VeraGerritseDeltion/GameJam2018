...
public class Spider : MonoBehaviour {
    ...
    private void Update(){
        ...
        if (BossFight.instance.grabbedPlayedLeft == false && BossFight.instance.grabbedPlayedRight == false && GameManager.instance.gameState != GameManager.GameState.Dead && BossFight.instance.spiderBossObject.activeInHierarchy) {
